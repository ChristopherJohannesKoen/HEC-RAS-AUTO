function filled_str = fill_space_before (str, nb_of_char)
% fill a string with spaces to reach a target length
%
% Syntax : filled_str = fill_space_before (str, nb_of_char)
%
% Param : str, string
%
...
% spaces before it to reach a target length
%
% See also
% fill_space_before
%
